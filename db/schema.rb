...
ActiveRecord::Schema.define(version: 20150912140248) do
  ...
  create_table "pligg_files", primary_key: "file_id", force: :cascade do |t|
    t.string  "file_name",       limit: 255
    t.string  "file_size",       limit: 20
    t.integer "file_user_id",    limit: 4,                     null: false
    t.integer "file_link_id",    limit: 4,                     null: false
    t.integer "file_orig_id",    limit: 4,                     null: false
    t.integer "file_real_size",  limit: 4,                     null: false
    t.integer "file_number",     limit: 1,                     null: false
    t.integer "file_ispicture",  limit: 1,                     null: false
    t.text    "file_fields",     limit: 65535,                 null: false
    t.boolean "file_hide_thumb",               default: false, null: false
    t.boolean "file_hide_file",                default: false, null: false
    t.integer "file_comment_id", limit: 4,     default: 0,     null: false
  end
  ...
  create_table "pligg_likes", id: false, force: :cascade do |t|
    t.integer "like_update_id", limit: 4, null: false
    t.integer "like_user_id",   limit: 4, null: false
  end
  ...
  create_table "pligg_spam_comments", primary_key: "auto_id", force: :cascade do |t|
    t.integer  "userid",      limit: 4,     default: 0, null: false
    t.integer  "linkid",      limit: 4,     default: 0, null: false
    t.integer  "cmt_rand",    limit: 4,     default: 0, null: false
    t.text     "cmt_content", limit: 65535,             null: false
    t.datetime "cmt_date",                              null: false
    t.integer  "cmt_parent",  limit: 4,     default: 0, null: false
  end

  create_table "pligg_spam_links", primary_key: "auto_id", force: :cascade do |t|
    t.integer "userid", limit: 4, default: 0, null: false
    t.integer "linkid", limit: 4, default: 0, null: false
  end
  ...
  create_table "pligg_updates", primary_key: "update_id", force: :cascade do |t|
    t.integer "update_time",     limit: 4
    t.string  "update_type",     limit: 1,     null: false
    t.integer "update_link_id",  limit: 4,     null: false
    t.integer "update_user_id",  limit: 4,     null: false
    t.integer "update_group_id", limit: 4,     null: false
    t.integer "update_likes",    limit: 4,     null: false
    t.string  "update_level",    limit: 25
    t.text    "update_text",     limit: 65535, null: false
  end

  add_index "pligg_updates", ["update_text"], name: "update_text", type: :fulltext
  ...
  create_table "pligg_users", primary_key: "user_id", force: :cascade do |t|
    ...
    t.boolean  "status_switch",                                             default: true
    t.boolean  "status_friends",                                            default: true
    t.boolean  "status_story",                                              default: true
    t.boolean  "status_comment",                                            default: true
    t.boolean  "status_email",                                              default: true
    t.boolean  "status_group",                                              default: false
    t.boolean  "status_all_friends",                                        default: true
    t.text     "status_friend_list", limit: 65535
    t.text     "status_excludes",    limit: 65535
  end
